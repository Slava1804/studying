# https://stepik.org/lesson/590035/step/21?thread=solutions&unit=584967
...
for dep, person in staff_broken:
        staff[dep].add(person)

for key, value in sorted(staff.items()):
    print(f'{key}: ', end='')
